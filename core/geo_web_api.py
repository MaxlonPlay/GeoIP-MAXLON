    ...
    def do_GET(self):
        ...
        if ip_address == "" or ip_address == "/":
            try:
                ...
                self._send_response(404, "text/html", "<h1>404 - Home page non trovata</h1>")
            return
...
class GeoWebAPI:
    def __init__(self):
        ...
        self.daemon_web_port = int(os.getenv("DAEMON_WEB_PORT", 8881))
    ...
    def start(self):
        ...
        try:
            ...
            self.server_thread = threading.Thread(
                target=self.server.serve_forever, daemon=False
            )
