...
class GeoCliServer:
    def __init__(self, lookup_service: GeoLookupService):
        ...
        self._stopped = False  # Flag per evitare doppio logging
    ...
    def start(self):
        ...
        try:
            ...
            # Cleanup del socket se non già fatto
    ...
    def _handle_client(self, client_socket):
        try:
            ...
            if request['action'] == 'lookup':
                ...
                if matching_row:
                    response['asn_cidrs'] = self.lookup_service.get_asn_cidrs(matching_row['asn'])
